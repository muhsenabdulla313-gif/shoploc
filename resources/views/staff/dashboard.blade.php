    ...
    @endphp
            ...
            <div class="p-3">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        {{ $staff->created_at ? \Carbon\Carbon::parse($staff->created_at)->format('d M Y') : 'N/A' }}
                    </div>
                </div>
        ...
        <section class="panel mb-4">
            ...
            <div class="p-3">
                <div class="d-flex flex-column flex-md-row align-items-md-center gap-3">
                    <div class="flex-grow-1">
                        <input type="text" id="referralLink" class="form-control"
                            value="{{ $refLink ?? 'Generating referral link...' }}" readonly
                ...
                <div class="mt-2">
                    <small class="text-muted">Share this link to earn referral points when others sign up or make
                        purchases</small>
                </div>
            </div>
        </section>
        ...
        <section class="panel mb-4">
            ...
            <div class="p-3">
                @if(isset($adminMessages) && count($adminMessages) > 0)
                    <div class="space-y-4">
                        @foreach($adminMessages as $message)
                            <div
                                class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5">
                ...
                @else
                    <div
                        class="text-center py-10 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-dashed border-blue-200">
